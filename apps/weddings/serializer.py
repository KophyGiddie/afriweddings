...
class PublicWeddingSerializer(serializers.Serializer):
    ...
    wedding_date = serializers.CharField(source='get_wedding_date')
    couple_picture_mobile = serializers.URLField(source='get_couple_picture_mobile')
...
class WeddingSerializer(serializers.Serializer):
    ...
    public_url = serializers.CharField()
    is_public = serializers.BooleanField()
    planner_created = serializers.BooleanField()
