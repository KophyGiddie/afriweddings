...
class BudgetCategory(models.Model):
    ...
    total_estimated_cost = models.DecimalField(max_digits=9, decimal_places=2, default=0)
    total_final_cost = models.DecimalField(max_digits=9, decimal_places=2, default=0)
    total_paid = models.DecimalField(max_digits=9, decimal_places=2, default=0)
    total_pending = models.DecimalField(max_digits=9, decimal_places=2, default=0)
...
class BudgetExpense(models.Model):
    ...
    pending = models.DecimalField(max_digits=9, decimal_places=2, default=0)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now_add=True)
